...
<div id="app-cover">
    ...
    <div id="player">
        ...
        <div id="player-content">
            <div id="album-art">
                <img src="/img/${audio.photo}" class="active" id="_1">
                <img src="/img/${audio.photo}" class="active" id="_2">
...
<script>
    $(function()
    {
        var playerTrack = $("#player-track"), bgArtwork = $('#bg-artwork'), bgArtworkUrl, albumName = $('#album-name'),
            ...
            bTime, nTime = 0, buffInterval = null, tFlag = false, albums = ['${audio.audioName}','${audio.audioName}'],
            trackNames = ['${audio.userName}','${audio.userName}'],
            albumArtworks = ['_1','_2'],
            trackUrl = ['/img/${audio.url}','/img/${audio.url}'],
