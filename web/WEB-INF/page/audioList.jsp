...
<header class="am-topbar am-topbar-fixed-top wos-header">
    <div class="am-container">
        ...
        <div class="am-collapse am-topbar-collapse" id="collapse-head">
            ...
            <form action="<%=basePath%>audioList/likeName" class="am-topbar-form am-topbar-left am-form-inline" role="search">
...
<div class="am-container" style="margin: 100px auto">
    <ul data-am-widget="pagination" class="am-pagination am-pagination-default am-text-center">
        ...
        <li class="am-pagination-first ">
            <a href="<c:url value="/audioList/${categoryId}?page=1"/>">首页</a>
        </li>

        <li class="am-pagination-prev ">
            <a href="<c:url value="/audioList/${categoryId}?page=${pageInfo.pageNum-1>1?pageInfo.pageNum-1:1}"/>">&laquo;</a>
        </li>
        ...
        <c:forEach begin="${start}" end="${end}" varStatus="loop">
            ...
            <li class="${active}">
                <a href="<c:url value="/audioList/${categoryId}?page=${loop.index}"/>">${loop.index}</a>
            </li>
        </c:forEach>


        <li class="am-pagination-next ">
            <a href="<c:url value="/audioList/${categoryId}?page=${pageInfo.pageNum+1<pageInfo.pages?pageInfo.pageNum+1:pageInfo.pages}"/>">&raquo;</a>
        </li>

        <li class="am-pagination-last ">
            <a href="<c:url value="/audioList/${categoryId}?page=${pageInfo.pages}"/>">尾页</a>
        </li>
    </ul>
</div>
